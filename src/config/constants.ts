...
export const TIMELINE_EVENTS = [
  ...
  { time: '6:45 PM', event: 'Saludo a invitados y sesión de fotos', icon: '📸' },
  { time: '7:30 PM', event: 'Brindis', icon: '🍾' },
  { time: '8:00 PM', event: 'Cena', icon: '🍽️' },
  { time: '9:00 PM', event: 'Lanzamiento de ramo y liga', icon: '💐' },
...
export const TRANSPORT_OPTIONS = [
  ...
  { value: 'van_mosquera', label: 'Van desde Mosquera - 4:00 PM' },
  { value: 'van_danubio', label: 'Van desde Danubio Azul - 3:00 PM' },
  { value: 'van_portal80', label: 'Van desde Portal 80 - 4:00 PM' },
]
